...
if setup == false
	...
	for(var p = 0; p < page_number; p++)
		...
		//find the characters on each page and store them. 
		...
		for(var c = 0; c < text_length[p]; c++)
			...
			//find the (width) thiccness of the line
		...
		for	(var c = 0; c < text_length[p]; c++)
			...
			//add to the x/y coordinates based on new info
...
if speaker_sprite[page] != noone 
	...
	if speaker_side[page] == -1 {_speaker_x += 64};
	
	draw_sprite_ext(txtb_spr[page], txtb_img, textbox_x + portrait_x_offset[page], textbox_y, 64/txtb_spr_w, 64/txtb_spr_h, 0, c_white, 1);
